...
The arguments for different methods in both my_cross_val and my_train_test are the string of the method names (i.e. " MyLogisticReg2" and "MyLogisticRegGen")

Each of the iteration number will be printed when q4.py is running in order to keep track of the gradient descent since it could take a few minutes. 

The step size and the number of iterations are determined by textbook and experiment.
